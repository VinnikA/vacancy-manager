  ...
  return (
    <div className="border rounded-lg w-[300px] mt-4 mx-auto p-4 bg-white text-slate-700">
      ...
      <p className="mb-4">
        ...
        voluptatibus deleniti quis error eaque unde, ratione debitis explicabo
        dicta aliquam suscipit! Obcaecati, iste a? Molestiae repudiandae et
        aliquam perspiciatis suscipit?
      </p>
